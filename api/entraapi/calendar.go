...
func GetCalendars(r *http.Request, pAccessToken *oauth2.Token, pCalendarsContainer *CalendarsContainer) error {
	// Access Tokenを使用してユーザー情報を取得
	...
	if pError := json.NewDecoder(pResponse.Body).Decode(pCalendarsContainer); pError != nil {
